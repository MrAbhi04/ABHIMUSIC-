...
from ABHIMUSIC.utils.database import get_authuser_names, get_cmode
from ABHIMUSIC.utils.decorators import ActualAdminCB, AdminActual, language
from ABHIMUSIC.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await ABHI.stop_stream(message.chat.id)
    except:
        pass
