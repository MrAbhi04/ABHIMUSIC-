...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("MUSIC_BOT_ll")
                await self.one.join_chat("MUSIC_BOT_ll")
                await self.one.join_chat("MUSIC_BOT_ll")
                await self.one.join_chat("MUSIC_BOT_ll")
            except:
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("MUSIC_BOT_ll")
                await self.two.join_chat("MUSIC_BOT_ll")
                await self.two.join_chat("MUSIC_BOT_ll")
                await self.two.join_chat("MUSIC_BOT_ll")
            except:
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("MUSIC_BOT_ll")
                await self.three.join_chat("MUSIC_BOT_ll")
                await self.three.join_chat("MUSIC_BOT_ll")
                await self.three.join_chat("MUSIC_BOT_ll")
            except:
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("MUSIC_BOT_ll")
                await self.four.join_chat("MUSIC_BOT_ll")
                await self.four.join_chat("MUSIC_BOT_ll")
                await self.four.join_chat("MUSIC_BOT_ll")
            except:
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("MUSIC_BOT_ll")
                await self.five.join_chat("MUSIC_BOT_ll")
                await self.five.join_chat("MUSIC_BOT_ll")
                await self.five.join_chat("MUSIC_BOT_ll")
            except:
